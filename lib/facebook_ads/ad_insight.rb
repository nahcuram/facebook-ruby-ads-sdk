module FacebookAds
  ...
  class AdInsight < Base
    FIELDS = %w[account_id campaign_id adset_id ad_id objective impressions actions call_to_action_clicks cost_per_action_type unique_actions cost_per_unique_action_type clicks cpc cpm cpp ctr spend reach relevance_score].freeze
