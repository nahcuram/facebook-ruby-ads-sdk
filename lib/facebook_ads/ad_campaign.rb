module FacebookAds
  ...
  class AdCampaign < Base
    ...
    def create_ad_set(name: nil, promoted_object: nil, targeting: nil, daily_budget: nil, optimization_goal: nil, billing_event: 'IMPRESSIONS', status: 'ACTIVE', is_autobid: true)
